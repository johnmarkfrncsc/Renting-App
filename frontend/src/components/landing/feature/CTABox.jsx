...
const CTABox = () => {
  return (
    <div className="px-5 md:px-6 py-16 md:py-20">
      <div className="max-w-lg mx-auto text-center bg-base-100 border border-base-300/60 rounded-2xl px-8 py-14 md:px-14">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <a
            href="#"
            className="w-full sm:w-auto inline-flex items-center justify-center px-5 py-2.5 rounded-lg text-sm font-medium border border-base-300 bg-base-100 text-base-content hover:bg-base-200 transition-all"
          >
            Learn more
          </a>
        </div>
